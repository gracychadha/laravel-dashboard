...
class CommitmentOneController extends Controller
{
    //
    public function index()
    {
        $CommitmentOne = CommitmentOne::firstOrCreate(
            [],
            [
        ...
        return view('admin.pages.commitment-one-section', compact('CommitmentOne'));
    }
    public function update(Request $request)
    {
        $CommitmentOne = CommitmentOne::firstOrFail();
