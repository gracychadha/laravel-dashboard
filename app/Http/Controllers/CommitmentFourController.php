...
class CommitmentFourController extends Controller
{
    //
    public function index()
    {
        $CommitmentFour = CommitmentFour::firstOrCreate(
            [],
            [
        ...
        return view('admin.pages.commitment-four-section', compact('CommitmentFour'));
    }
    public function update(Request $request)
    {
        $CommitmentFour = CommitmentFour::firstOrFail();
