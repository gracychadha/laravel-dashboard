...
class PlanManagementBenefitController extends Controller
{
    //
    //
    public function index()
    {
        $section = PlanManagementBenefit::firstOrCreate(
            ['id' => 1],
            [
        ...
        return view('admin.pages.plan-management-benefit', compact('section'));
    }

    public function update(Request $request, PlanManagementBenefit $section)
    {
        ...
        for ($i = 1; $i <= 4; $i++) {
            ...
            if ($request->hasFile($field)) {
                ...
                $validated[$field] = $request->file($field)->store('PlanManagementBenefits', 'public');
            }
        }
