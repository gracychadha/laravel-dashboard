...
@section("title", " Privacy Policy | Diagnoedge")
@section("content")
    {{-- main section --}}
    <main class="main">
        ...
        @php
            $privacyPolicyContent = \App\Models\PrivacyPolicy::first();
        @endphp
            ...
            @if ($privacyPolicyContent)
                <div class="section-title-area">
                    <div class="section-title wow fadeInLeft" data-wow-delay=".2s">
                        <span class="sub-title">{{ $privacyPolicyContent->sub_title }}</span>
                        <h2>{{$privacyPolicyContent->main_title}} </h2>
                    </div>
                </div>
              <div class="container">
