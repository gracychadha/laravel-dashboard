...
@section("title", "Value Section | Continuity Care")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Value Section</li>
                </ol>
            </div>
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i> &nbsp;Value Section</h5>

                        </div>

                        <div class="card-body">
                            <form action="{{ route('value.update', $section) }}" method="POST"
                                ...
                                <ul class="nav nav-tabs mb-4" id="contentTabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                            href="#feature-cards">Values Cards</a></li>
                                </ul>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="card h-100 shadow-sm border-0">
                                                        <div class="card-body text-center">
                                                            ...
                                                            <small class="text-muted">80x80px recommended</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endfor
