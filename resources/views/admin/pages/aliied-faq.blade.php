...
@section("title", "Allied Health FAQs | Continuity Care")
...
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Allied Health FAQs</li>
                </ol>
            </div>
                                ...
                                @forelse($faqs as $faq)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('allied-health-faqs.destroy', $faq) }}" method="POST"
                                                class="d-inline">
                                                @csrf @method('DELETE')
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog custom-modal">
            <form action="{{ route('allied-health-faqs.store') }}" method="POST">
                @csrf
    ...
    @foreach($faqs as $faq)
        ...
        <div class="modal fade" id="edit{{ $faq->id }}">
            <div class="modal-dialog custom-modal">
                <form action="{{ route('allied-health-faqs.update', $faq) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="modal-content">
                        <div class="modal-header bg-theme-light">
                            <h5>Edit FAQ</h5>
