...
@section("title", "Support Coordination Plan Section | Continuity Care")
...
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Support Coordination Plan Section</li>
                </ol>
            </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped bg-theme" id="testimonialTable">
                            ...
                            <tbody>
                                @forelse($SupportCoordinationPlanCard as $card)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('support-coordination-plan.destroy', $card) }}" method="POST"
                                                class="d-inline">
                                                @csrf @method('DELETE')
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog custom-modal bg-theme-light">
            <form action="{{ route('support-coordination-plan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <!-- View & Edit Modals -->
    @foreach($SupportCoordinationPlanCard as $card)
        <!-- View Modal -->
        ...
        <div class="modal fade" id="edit{{ $card->id }}">
            <div class="modal-dialog custom-modal">
                <form action="{{ route('support-coordination-plan.update', $card) }}" method="POST" enctype="multipart/form-data">
                    @csrf @method('PUT')
                    <div class="modal-content">
                        <div class="modal-header bg-theme-light">
                            <h5>Edit section</h5>
