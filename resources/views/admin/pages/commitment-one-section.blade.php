                ...
                <div class="col-lg-12">
                    <div class="card border shadow-sm h-100">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i> Commitment Section</h5>

                        </div>
                        <div class="card-body">


                            <form action="{{ route('commitment-one.update') }}" method="POST"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $CommitmentOne->main_title) }}</textarea>
                                            @error('main_title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="sub_title"
                                                ...
                                                required>{{ old('sub_title', $CommitmentOne->sub_title) }}</textarea>
                                            @error('sub_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description_1"
                                                ...
                                                required>{{ old('description_1', $CommitmentOne->description_1) }}</textarea>
                                            @error('description_1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
