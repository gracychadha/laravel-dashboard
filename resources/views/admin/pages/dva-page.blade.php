...
@section("title", "DVA Page | Continuity Care")
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">DVA Page</li>
                </ol>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card border shadow-sm h-100">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i>&nbsp;DVA Page</h5>

                        </div>
                        <div class="card-body">


                            <form action="{{ route('dva-page.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            @if($DvaSections->image_1 && \Illuminate\Support\Facades\Storage::disk('public')->exists($DvaSections->image_1))
                                                <div class="position-relative mb-3">
                                                    <img src="{{ asset('storage/' . $DvaSections->image_1) }}"
                                                        class="img-fluid rounded shadow-sm"
                                                        style="max-height: 200px; width: 100%; object-fit: cover;" alt="Image 1"
                                                        onerror="this.style.display='none'; console.log('Image failed to load: {{ $DvaSections->image_1 }}')">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            @if($DvaSections->image_2 && \Illuminate\Support\Facades\Storage::disk('public')->exists($DvaSections->image_2))
                                                <div class="position-relative mb-3">
                                                    <img src="{{ asset('storage/' . $DvaSections->image_2) }}"
                                                        class="img-fluid rounded shadow-sm"
                                                        style="max-height: 200px; width: 100%; object-fit: cover;" alt="Image 1"
                                                        onerror="this.style.display='none'; console.log('Image failed to load: {{ $DvaSections->image_2 }}')">
                                                    <small class="text-success d-block mt-1">
                                                        <i class="fas fa-check-circle"></i> Image loaded successfully
                                                    </small>
                                                </div>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="about_content"
                                                ...
                                                required>{{ old('about_content', $DvaSections->about_content) }}</textarea>
                                            @error('about_content')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="service_title"
                                                ...
                                                required>{{ old('service_title', $DvaSections->service_title) }}</textarea>
                                            @error('service_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="service_about"
                                                ...
                                                required>{{ old('service_about', $DvaSections->service_about) }}</textarea>
                                            @error('service_about')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="eligibility"
                                                ...
                                                required>{{ old('eligibility', $DvaSections->eligibility) }}</textarea>
                                            @error('eligibility')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div id="points-wrapper">
                                            @if(!empty($DvaSections->points) && is_array($DvaSections->points))
                                                @foreach($DvaSections->points as $index => $point)
