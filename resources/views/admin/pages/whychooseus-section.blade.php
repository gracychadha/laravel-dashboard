                    ...
                    <div class="card-body">
                        <form action="{{ route('whychooseus.section.update', $section) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <ul class="nav nav-tabs mb-4" id="contentTabs">
                                <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#text-content">Text Content</a></li>
                                <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#big-card">Main Card</a></li>
                                <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#feature-cards">Feature Cards</a></li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="text-content">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="description_1" class="form-control summernote">{{ old('description_1', $section->description_1) }}</textarea>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label fw-bold">Additional Description</label>
                                            <textarea name="description_2" class="form-control summernote">{{ old('description_2', $section->description_2) }}</textarea>
                                        </div>
                                    </div>
                                </div>
