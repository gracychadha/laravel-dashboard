                ...
                <div class="col-xl-3 col-xxl-4 col-lg-4">
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            <h3 class="fs-20 mb-0 text-black">Leads</h3>
                ...
                <div class="col-xl-3 col-xxl-4 col-lg-5">
                    <div class="card border-0 pb-0">
                        <div class="card-header flex-wrap border-0 pb-0">
                            <h3 class="fs-20 mb-0 text-black">User's List</h3>
                            <a href="{{ route('admin-register.index') }}" class="text-primary font-w500">View more >></a>
                        </div>
                                    ...
                                    @forelse($users as $user)
                                        <li>
                                            <div class="timeline-panel flex-wrap">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mb-1"><a class="text-black" href="{{ route('admin-register.index') }}">{{ $user->name }}</a></h5>
                                                    <span class="fs-14">{{ $user->email }}</span>
                                                </div>
                                                <a href="javascript:void(0);" class="text-primary mt-2">User</a>
                                            </div>
                                        </li>
                                    @empty
                                    <p>No User Found</p>
            ...
            var options = {
                ...
                legend: {
                    ...
                    markers: {
                        ...
                        radius: 19,
                        strokeColor: '#fff',
                        fillColors: ['#369DC9', 'var(--primary)', '#F46B68', '#2BC155'] // 4 colors
                    }
                },
                ...
                xaxis: {
                    categories: {!! json_encode($months) !!}  // REAL month labels
                },

                fill: {
                    colors: ['#369DC9', 'var(--primary)', '#F46B68', '#2BC155'],
                    opacity: 1
                },
        ...
        var chartBar = function () {
            var optionsArea = {
                series: [{
                    ...
                    data: {!! json_encode($dailyAppointmentData) !!}
                }],
