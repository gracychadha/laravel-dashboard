...
@section("title", "Plan Management About Section | Continuity Care")
...
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Plan Management About Section</li>
                </ol>
            </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped bg-theme" id="testimonialTable">
                            ...
                            <tbody>
                                @forelse($PlanManagementAboutCard as $card)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('plan-management-about.destroy', $card) }}"
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog custom-modal bg-theme-light">
            <form action="{{ route('plan-management-about.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <!-- View & Edit Modals -->
    @foreach($PlanManagementAboutCard as $card)
        <!-- View Modal -->
        ...
        <div class="modal fade" id="edit{{ $card->id }}">
            <div class="modal-dialog custom-modal">
                <form action="{{ route('plan-management-about.update', $card) }}" method="POST"
