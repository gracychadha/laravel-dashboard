                        ...
                        <tbody>
                            @forelse($sliderImages as $sliderImage)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/' . $sliderImage->image) }}"
                                             class="rounded" style="width: 80px; height: 60px; object-fit: contain; border: 1px solid #eee;">
                                    </td>
                                    <td>
                                        <span class="badge light badge-{{ $sliderImage->status == 'active' ? 'success' : 'danger' }}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{ route('sliderimage.destroy', $sliderImage) }}" method="POST" class="d-inline">
                                            @csrf @method('DELETE')
