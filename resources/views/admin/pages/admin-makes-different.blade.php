...
@section("title", "About What makes us different | Diagnoedge")
                ...
                <div class="col-12">
                    <div class="card border shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin-about-makes.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title" 
                                                      ...
                                                      rows="2" required>{{ old('main_title', $AboutMakes->main_title) }}</textarea>
                                            @error('main_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description" 
                                                      ...
                                                      rows="4" required>{{ old('description', $AboutMakes->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
