...
@section("title", "Home Care Service Section | Continuity Care")
...
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Home Care Service Section</li>
                </ol>
            </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped bg-theme" id="testimonialTable">
                            ...
                            <tbody>
                                @forelse($HomeCare2Cards as $card)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('home-care-service.destroy', $card) }}" method="POST"
                                                class="d-inline">
                                                @csrf @method('DELETE')
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog custom-modal bg-theme-light">
            <form action="{{ route('home-care-service.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <button type="button" class="btn btn-sm btn-primary mt-2" onclick="addPoint()">
                                + Add Point
                            </button>
    ...
    <!-- View & Edit Modals -->
    @foreach($HomeCare2Cards as $card)
        <!-- View Modal -->
        ...
        <div class="modal fade" id="edit{{ $card->id }}">
            <div class="modal-dialog custom-modal">
                <form action="{{ route('home-care-service.update', $card) }}" method="POST" enctype="multipart/form-data">
                    @csrf @method('PUT')
                    <div class="modal-content">
                        <div class="modal-header bg-theme-light">
                            <h5>Edit section</h5>
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-primary mt-2"
                                    onclick="addPoint('points-wrapper-{{ $card->id }}')">
                                    + Add Point
                                </button>
                                <div class="col-12">
                                    <label>Description <span class="text-danger">*</span></label>
