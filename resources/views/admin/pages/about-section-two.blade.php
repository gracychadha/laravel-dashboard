...
@section("title", "About Section (Know Us Better) | Continuity Care")
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    {{-- <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="is_active" id="statusSwitch" value="1" {{
                        ...
                        <div class="tab-content p-4 border border-top-0 rounded-bottom">
                            ...
                            <div class="tab-pane fade show active" id="text">
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        <label class="form-label fw-bold">Main Description <span
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="founded_year" class="form-control" placeholder="e.g. 1990"
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        @if($section->image_top)
                                            <div class="mt-2">
                                                <img src="{{ Storage::url($section->image_top) }}" class="img-thumbnail"
                                                    width="250" alt="Top Image">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if($section->image_bottom)
                                            <div class="mt-2">
                                                <img src="{{ Storage::url($section->image_bottom) }}" class="img-thumbnail"
                                                    width="200" alt="Bottom Image">
                                                <small class="text-muted d-block">Current image</small>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if($section->founded_image)
                                            <div class="mt-2 text-center">
                                                <img src="{{ Storage::url($section->founded_image) }}" width="80"
                                                    alt="Founded Icon">
