...
@section("title", "Support Coordination benefit | Continuity Care")
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Support Coordination benefit</li>
                </ol>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card border shadow-sm h-100">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i>&nbsp;Support Coordination benefit</h5>

                        </div>
                        <div class="card-body">


                            <form action="{{ route('support-coordination-benefit.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            @if($SupportCoordinationBenefits->image && \Illuminate\Support\Facades\Storage::disk('public')->exists($SupportCoordinationBenefits->image))
                                                <div class="position-relative mb-3">
                                                    <img src="{{ asset('storage/' . $SupportCoordinationBenefits->image) }}"
                                                        class="img-fluid rounded shadow-sm"
                                                        style="max-height: 200px; width: 100%; object-fit: cover;" alt="Image 1"
                                                        onerror="this.style.display='none'; console.log('Image failed to load: {{ $SupportCoordinationBenefits->image }}')">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $SupportCoordinationBenefits->main_title) }}</textarea>
                                            @error('main_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_1"
                                                ...
                                                required>{{ old('description_1', $SupportCoordinationBenefits->description_1) }}</textarea>
                                            @error('description_1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div id="points-wrapper">
                                            @if(!empty($SupportCoordinationBenefits->points) && is_array($SupportCoordinationBenefits->points))
                                                @foreach($SupportCoordinationBenefits->points as $index => $point)
