...
@section("title", "Community Nursing Act Section | Continuity Care")
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Community Nursing Act Section</li>
                </ol>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card border shadow-sm h-100">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i>&nbsp;Community Nursing Act Section</h5>

                        </div>
                        <div class="card-body">


                            <form action="{{ route('community-nursing-act.update') }}" method="POST"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $CommunityNursingActs->main_title) }}</textarea>
                                            @error('main_title')
                                        ...
                                        {{-- sub-tiitle --}}
                                         <div class="mb-3">
                                            ...
                                            <textarea name="sub_title"
                                                ...
                                                required>{{ old('sub_title', $CommunityNursingActs->sub_title) }}</textarea>
                                            @error('sub_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        {{-- side-tiitle --}}
                                         <div class="mb-3">
                                            ...
                                            <textarea name="side_title"
                                                ...
                                                required>{{ old('side_title', $CommunityNursingActs->side_title) }}</textarea>
                                            @error('side_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_1"
                                                class="form-control summernote @error('description_1') is-invalid @enderror" rows="2"
                                                required>{{ old('description_1', $CommunityNursingActs->description_1) }}</textarea>
                                            @error('description_1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div id="points-wrapper">
                                            @if(!empty($CommunityNursingActs->points) && is_array($CommunityNursingActs->points))
                                                @foreach($CommunityNursingActs->points as $index => $point)
