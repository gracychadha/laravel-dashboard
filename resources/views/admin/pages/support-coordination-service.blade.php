...
@section("content")
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped bg-theme" id="testimonialTable">
                            ...
                            <tbody>
                                @forelse($SupportCoordinationServiceCard as $card)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('support-coordination-service.destroy', $card) }}" method="POST"
                                                class="d-inline">
                                                @csrf @method('DELETE')
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog custom-modal bg-theme-light">
            <form action="{{ route('support-coordination-service.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <!-- View & Edit Modals -->
    @foreach($SupportCoordinationServiceCard as $card)
        <!-- View Modal -->
        ...
        <div class="modal fade" id="edit{{ $card->id }}">
            <div class="modal-dialog custom-modal">
                <form action="{{ route('support-coordination-service.update', $card) }}" method="POST"
