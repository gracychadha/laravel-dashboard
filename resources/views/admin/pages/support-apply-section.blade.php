...
@section("title", "Support Independent Apply Section | Continuity Care")
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Support Independent Apply Section</li>
                </ol>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card border shadow-sm h-100">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i>&nbsp;Support Independent Apply Section</h5>

                        </div>
                        <div class="card-body">


                            <form action="{{ route('support-apply.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            @if($SupportApplySections->image && \Illuminate\Support\Facades\Storage::disk('public')->exists($SupportApplySections->image))
                                                <div class="position-relative mb-3">
                                                    <img src="{{ asset('storage/' . $SupportApplySections->image) }}"
                                                        class="img-fluid rounded shadow-sm"
                                                        style="max-height: 300px; width: 100%; object-fit: cover;"
                                                        alt="Main Image"
                                                        onerror="this.style.display='none'; console.log('Image failed to load: {{ $SupportApplySections->image }}')">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $SupportApplySections->main_title) }}</textarea>
                                            @error('main_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description_1"
                                                ...
                                                rows="4"
                                                required>{{ old('description_1', $SupportApplySections->description_1) }}</textarea>
                                            @error('description_1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
