...
@section("title", "Community Benefits Section | Continuity Care")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Community Benefits Section</li>
                </ol>
            </div>
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i> &nbsp;Community Benefits Section</h5>

                        </div>

                        <div class="card-body">
                            <form action="{{ route('community-benefit.update', $section) }}" method="POST"
