...
@section("title", "Home Care Differences | Continuity Care")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Home Care differences</li>
                </ol>
            </div>
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i> &nbsp;Home Care Differences</h5>

                        </div>

                        <div class="card-body">
                            <form action="{{ route('home-care-difference.update', $section) }}" method="POST"
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="description" class="form-control"
                                                    value="{{ old('description', $section->description) }}" required>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <small class="text-muted d-block mt-2">Current Background Image</small>
                                            </div>
                                            <div class="col-9">
