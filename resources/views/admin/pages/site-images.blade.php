...
@section("title", "Site Images | Diagnoedge")
            ...
            <div class="col-lg-6">
                <div class="card border shadow-sm h-100">
                    ...
                    <div class="card-body ">
                        ...
                        <form action="{{ route('site-images.update-popup') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                            @csrf @method('PUT')
            ...
            <div class="col-lg-6">
                <div class="card border shadow-sm h-100">
                    ...
                    <div class="card-body ">
                        ...
                        <form action="{{ route('site-images.update-ads') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                            @csrf @method('PUT')
