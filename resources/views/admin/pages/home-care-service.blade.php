...
@section("title", "Home Care Page | Continuity Care")
    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Home Care Support Section</li>
            </ol>
        </div>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                        <h5 class="mb-0"><i class="fas fa-info-circle"></i> &nbsp;Home Care Support Section</h5>

                    </div>

                    <div class="card-body">
                        <form action="{{ route('home-care-support.update', $section) }}" method="POST"
                            ...
                            <div class="tab-content border border-top-0 rounded-bottom p-4 ">
                                ...
                                <div class="tab-pane fade" id="feature-cards">
                                    <div class="row g-4">
                                        @for($i = 1; $i <= 3; $i++) <div class="col-lg-12 col-md-6">
                                            <div class="card h-100 shadow-sm border-0">
                                                <div class="card-body text-center">
                                                    <img src="{{ $section->{"small_card_{$i}_image"} ?
                                                        Storage::url($section->{"small_card_{$i}_image"}) :
                                                    asset('images/default-icon.png') }}"
                                                    class="rounded-circle mb-3 shadow-sm"
                                                    style="width:80px;height:80px;object-fit:cover;">
                                                    <input type="text" name="small_card_{{ $i }}_title"
                                                        class="form-control mb-3" value="{{ old("
                                                        small_card_{$i}_title", $section->{"small_card_{$i}_title"}) }}"
                                                    placeholder="Card Title" required>
                                                    <input type="text" name="small_card_{{ $i }}_main_title"
                                                        class="form-control mb-3" value="{{ old("
                                                        small_card_{$i}_main_title",
                                                        $section->{"small_card_{$i}_main_title"}) }}"
                                                    placeholder="Card Title" required>
