...
@section("title", "Care Coordination About Section | Continuity Care")
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Care Coordination About Section</li>
                </ol>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card border shadow-sm h-100">
                        <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i>&nbsp;Care Coordination About Section</h5>

                        </div>
                        <div class="card-body">


                            <form action="{{ route('community-nursing-about.update') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            @if($CareCoordinationAbouts->image && \Illuminate\Support\Facades\Storage::disk('public')->exists($CareCoordinationAbouts->image))
                                                <div class="position-relative mb-3">
                                                    <img src="{{ asset('storage/' . $CareCoordinationAbouts->image) }}"
                                                        class="img-fluid rounded shadow-sm"
                                                        style="max-height: 300px; width: 100%; object-fit: cover;"
                                                        alt="Main Image"
                                                        onerror="this.style.display='none'; console.log('Image failed to load: {{ $CareCoordinationAbouts->image }}')">
                                            ...
                                            @else
                                                <div class="bg-light border-dashed rounded d-flex align-items-center justify-content-center mb-3"
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        @if($CareCoordinationAbouts->image)
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $CareCoordinationAbouts->main_title) }}</textarea>
                                            @error('main_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description_1"
                                                ...
                                                rows="4"
                                                required>{{ old('description_1', $CareCoordinationAbouts->description_1) }}</textarea>
                                            @error('description_1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <!-- Description 1 -->
                                        <div class="mb-4">
                                            <label class="form-label fw-bold"> Overview <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="description_2"
                                                class="form-control summernote  @error('description_2') is-invalid @enderror"
                                                rows="4"
                                                required>{{ old('description_2', $CareCoordinationAbouts->description_2) }}</textarea>
                                            @error('description_2')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
