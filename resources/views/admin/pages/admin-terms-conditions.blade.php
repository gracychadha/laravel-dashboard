...
@section("title", "Terms Conditions Content | Diagnoedge")
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4">
                                            <label class="form-label fw-bold">Primary Description <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="description" class="form-control summernote">{!! old('description', $TermsCondition->description)  !!}</textarea>
