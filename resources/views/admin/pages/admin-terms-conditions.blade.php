...
@section("title", "Terms Conditions Content | Continuity Care")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Terms Conditions Content</li>
                </ol>
            </div>
                    ...
                    <div class="card border shadow-sm h-100">
                        <form action="{{ route('admin-terms-condition.update') }}" method="POST"
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                                <h5 class="mb-0"><i class="fas fa-info-circle"></i> &nbsp; Terms &amp; Conditions </h5>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sub_title"
                                                ...
                                                value="{{ old('sub_title', $TermsCondition->sub_title) }}" required>
                                            @error('sub_title')
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description"
                                                class="form-control summernote">{!! old('description', $TermsCondition->description)  !!}</textarea>
