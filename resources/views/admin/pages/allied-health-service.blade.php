...
@section("title", "Allied Health Service | Continuity Care")
...
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Allied Health Service</li>
                </ol>
            </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped bg-theme" id="testimonialTable">
                            ...
                            <tbody>
                                @forelse($AlliedHealthServiceCard as $card)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('allied-health-service.destroy', $card) }}"
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog custom-modal bg-theme-light">
            <form action="{{ route('allied-health-service.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <!-- View & Edit Modals -->
    @foreach($AlliedHealthServiceCard as $card)
        <!-- View Modal -->
        ...
        <div class="modal fade" id="edit{{ $card->id }}">
            <div class="modal-dialog custom-modal">
                <form action="{{ route('allied-health-service.update', $card) }}" method="POST"
