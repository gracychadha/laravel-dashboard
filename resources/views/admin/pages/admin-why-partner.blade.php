...
@section("title", "Why Partner With Us Section | Continuity Care")
                ...
                <div class="col-12">
                    <div class="card border shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin-why-partner.update') }}" method="POST"
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $WhyPartners->main_title) }}</textarea>
                                            @error('main_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description"
                                                ...
                                                required>{{ old('description', $WhyPartners->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
