...
@section("title", "Why Partner With Us Section | Diagnoedge")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Why Partner With Us Section</li>
                </ol>
            </div>
                ...
                <div class="col-12">
                    <div class="card border shadow-sm h-100">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            {{-- <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_active" value="1" 
                                       {{ old('is_active', $WhyPartners->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin-why-partner.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            @if($WhyPartners->image && \Illuminate\Support\Facades\Storage::disk('public')->exists($WhyPartners->image))
                                                <div class="position-relative mb-3">
                                                    <img src="{{ asset('storage/' . $WhyPartners->image) }}"
                                                         class="img-fluid rounded shadow-sm" 
                                                         style="max-height: 300px; width: 100%; object-fit: cover;"
                                                         alt="Main Image"
                                                         onerror="this.style.display='none'; console.log('Image failed to load: {{ $WhyPartners->image }}')">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sub_title" 
                                                   ...
                                                   value="{{ old('sub_title', $WhyPartners->sub_title) }}" required>
                                            @error('sub_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title" 
                                                      ...
                                                      rows="2" required>{{ old('main_title', $WhyPartners->main_title) }}</textarea>
                                            @error('main_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description" 
                                                      ...
                                                      rows="4" required>{{ old('description', $WhyPartners->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
