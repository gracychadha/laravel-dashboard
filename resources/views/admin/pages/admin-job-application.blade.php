...
@section("title", "Career Job Applications | Diagnoedge Dashboard")
@section("content")
                                        ...
                                        @foreach($application as $applications)
                                            <tr>
                                                <td>
                                                    <div class="checkbox text-end align-self-center">
                                                        <div class="form-check custom-checkbox ">
                                                            <input type="checkbox" class="form-check-input checkItem"  value="{{ $applications->id }}"
                                                                required="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        {{-- <textarea class="form-control" name="resume" id="edit_resume" readonly></textarea> --}}
                                    </div>
                                </div>
