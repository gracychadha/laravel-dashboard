...
@section("title", "Community Nursing FAQs | Continuity Care")
...
@section("content")
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Community Nursing FAQs</li>
                </ol>
            </div>
                                ...
                                @forelse($faqs as $faq)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('community-nursing-faqs.destroy', $faq) }}" method="POST"
                                                class="d-inline">
                                                @csrf @method('DELETE')
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog custom-modal">
            <form action="{{ route('community-nursing-faqs.store') }}" method="POST">
                @csrf
    ...
    @foreach($faqs as $faq)
        ...
        <div class="modal fade" id="edit{{ $faq->id }}">
            <div class="modal-dialog custom-modal">
                <form action="{{ route('community-nursing-faqs.update', $faq) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="modal-content">
                        <div class="modal-header bg-theme-light">
                            <h5>Edit FAQ</h5>
